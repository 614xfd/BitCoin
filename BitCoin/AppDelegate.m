...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    // Override point for customization after application launch.
     ...
     self.window.rootViewController = [self.window.rootViewController.storyboard instantiateViewControllerWithIdentifier:@"AdvertisementVC"];
    ...
    [JPUSHService setupWithOption:launchOptions appKey:@"3b256d30254fd5cb19078927"
                          channel:@"0"
                 apsForProduction:0
