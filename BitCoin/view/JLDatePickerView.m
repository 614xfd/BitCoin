...
- (void)setupCancelAndConfirmButton {
    ...
    [cancelButton setTitleColor:[UIColor colorWithRed:110/255.0 green:111/255.0 blue:112/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    [confirmButton setTitleColor:[UIColor colorWithRed:38/255.0 green:162/255.0 blue:38/255.0 alpha:1] forState:UIControlStateNormal];
...
- (void)setupPicker {
    if (_type == JLDatePickerModeNomal) {
        ...
        [self.datePicker selectRow:[s intValue]-1900 inComponent:0 animated:NO];
...
-(NSMutableArray *)yearArr{
    if (!_yearArr) {
        ...
        [formatter1 setDateFormat:@"yyyy"];
        NSString *s = [formatter1 stringFromDate:[NSDate date]];
        for (int i = 1900; i<[s intValue]+1; i++) {
